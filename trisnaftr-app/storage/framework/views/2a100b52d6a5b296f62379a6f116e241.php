    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>" alt="logo" style="width: 40px;"></a>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in the world by the <a href="#" class="text-black">Bootstrap team</a> with the help of <a href="#"
...
<?php /**PATH C:\Users\62812\trisnaftr-app\resources\views/cloningbs.blade.php ENDPATH**/ ?>